                    ...
                    <div class="con-tent-main">
                        <div class="wrapper">
                            ...
                            <div class="slug skew-up">
                                ...
                                <a class="active  text-dark" href="index.php">CarbonFree RECDs</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="rts-service-details-area rts-section-gap">
        <div class="container">
            ...
            <div class="row align-items-center mb-5 flex-wrap">
                ...
                <div class="col-lg-6">
                    <p>Novorbis Itus Pvt. Ltd. is a pioneer in air purification and emission control. Driven by a clear
                        purpose we aim to make the air cleaner and the planet healthier through smart, sustainable
                        innovation.</p>
                </div>
            </div>

            <!-- Section 2: Text Left, Image Right -->
            <div class="row align-items-center mb-5 flex-wrap flex-lg-row-reverse">
                <div class="col-lg-6">
                    <img src="assets/images/service/recd.jpg" data-aos="zoom-in" class="img-fluid p-image"
                        alt="Why Choose RECD">
                </div>
                <div class="col-lg-6">
                    <p>We are proudly India’s first manufacturer of truly filter-less Retrofit Emission Control
                        Devices (RECDs)</p>
                    <p>Our RECDs reduce harmful emissions and improve air quality, creating real impact where it
                        matters most.</p>
                </div>
            </div>
